        ...
        <div className="container-x">
          ...
          <div className="grid lg:grid-cols-5 gap-12 lg:gap-20">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-[1.6]">
                      Thozhookkara, Thaneercode P.O.,<br />
            ...
            <div className="lg:col-span-3">
              <div className="bg-white rounded-[2rem] shadow-card border border-border/50 p-8 md:p-12">
      ...
      <section className="h-[400px] md:h-[500px] bg-secondary relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-ink/5 flex items-center justify-center border-t border-border">
          <div className="text-center">
            <Map className="h-16 w-16 text-burgundy/40 mx-auto mb-4" />
            <h3 className="font-display text-2xl text-burgundy mb-2">Interactive Campus Map</h3>
            <p className="text-muted-foreground mb-6 max-w-sm mx-auto">
              [Google Maps Embed would go here in production showing Thozhookkara, Thaneercode P.O., Kerala]
            </p>
            <Button asChild variant="outline" className="rounded-full bg-white">
              <Link to="https://maps.app.goo.gl/GTwSscnTnhxPvje9A">Open in Google Maps</Link>
            </Button>
          </div>
        </div>
      </section>
