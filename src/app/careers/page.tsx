          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="relative">
              <div className="relative aspect-[4/3] overflow-hidden shadow-2xl">
                <img src={teachersImg.src} alt="Joining Edinwood" className="w-full h-full object-cover" />
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="order-1 lg:order-2">
              <div className="relative aspect-[4/3] overflow-hidden shadow-xl">
                <img src={mentoringImg.src} alt="Teacher Mentoring" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-secondary">
        <div className="container-x">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="relative">
              <div className="relative aspect-[4/3] overflow-hidden shadow-xl">
                <img src={staffRoomImg.src} alt="Staff Community" className="w-full h-full object-cover" />
              </div>
            </div>
            <div>
        ...
        <div className="container-x">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {vacancies.map((job, idx) => (
              <div key={idx} className="group bg-white p-8 border border-border/50 hover:border-burgundy/20 hover:shadow-xl transition-all duration-300">
