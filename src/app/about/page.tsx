...
const timeline = [
  { year: "2024", title: "The Vision", desc: "Passionate educators set out to build a modern, inquiry-led academy." },
  { year: "2025", title: "Groundbreaking", desc: "Construction begins on our state-of-the-art." },
  { year: "Campus", title: "Assembling the Team", desc: "Recruiting world-class faculty from around the globe." },
...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-background">
      ...
      <section id="mission-vision" className="py-16 md:py-24 bg-secondary">
        <div className="container-x">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-[10px]">
            <div className="bg-white p-10 shadow-sm border border-border/50 text-center hover:-translate-y-2 transition-transform duration-300">
            ...
            <div className="bg-burgundy text-white p-10 shadow-card text-center hover:-translate-y-2 transition-transform duration-300">
      ...
      <section id="our-journey" className="py-16 md:py-24">
        <div className="container-x">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground leading-[1.7]">
                <p>
                  Edinwood International school was born from a singular, powerful vision: to build a school for the future, right from the ground up. We saw the need for an education that goes beyond rote learning and puts the child at the absolute center of the experience.
                </p>
                <p>
              ...
              <div className="space-y-12">
                {timeline.map((item, idx) => (
                  <div key={idx} className={`relative flex flex-col md:flex-row gap-8 items-start md:items-center ${idx % 2 !== 0 ? 'md:flex-row-reverse text-left md:text-right' : ''}`}>
                    ...
                    <div className="w-full md:w-1/2 bg-secondary/50 p-6">
        ...
        <div className="container-x">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative aspect-video overflow-hidden">
              <img src={storyImg.src} alt="Campus facilities" className="w-full h-full object-cover" />
            </div>
            <div>
              ...
              <p className="text-muted-foreground leading-[1.7] mb-6">
                Our campus is a carefully curated environment that blends nature with cutting-edge technology. Featuring an Edinwood Signature Field FIFA-affiliated football ground with coaching by the Juventus Football Academy, advanced STEM labs, and an expansive library, every facility is designed to provide students with the resources they need to excel.
              </p>
      ...
      <section id="leadership" className="py-16 md:py-24 bg-secondary">
        <div className="container-x">
          ...
          <div className="text-center mt-12">
             <Button asChild variant="outline" className="rounded-full px-8 h-12">
                <Link href="/faculty">Meet All Faculty</Link>
             </Button>
          </div>
        </div>
      </section>
      ...
      <section id="achievements" className="py-16 md:py-20 border-y border-border">
        <div className="container-x">
      ...
      {/* 7. Community & Parents */}
      <section id="community" className="py-16 md:py-24 text-center max-w-4xl mx-auto px-4">
